...
require_relative "lib/wavix/version"
...
Gem::Specification.new do |spec|
  spec.name = "wavix-ruby-sdk"
  spec.authors = ["Wavix"]
  spec.version = Wavix::VERSION
  spec.summary = "Ruby client library for the Wavix API"
  spec.description = "The Wavix Ruby library provides convenient access to the Wavix API from Ruby."
