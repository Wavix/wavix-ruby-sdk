...
describe Wavix::Internal::Types::Union do
  class Rectangle < Wavix::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Wavix::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Wavix::Internal::Types::Model
