...
describe Wavix::Internal::Types::Model do
  ...
  class ExampleModel < Wavix::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Wavix::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Wavix::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Wavix::Internal::Types::Model
