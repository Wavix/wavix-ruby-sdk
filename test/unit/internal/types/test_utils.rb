...
describe Wavix::Internal::Types::Utils do
  Utils = Wavix::Internal::Types::Utils

  module TestUtils
    class M < Wavix::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Wavix::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Wavix::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Wavix::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Wavix::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Wavix::Internal::Types::Array[String]
      ModelArray = -> { Wavix::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Wavix::Internal::Types::Array[TestUtils::U] }
