...
module Wavix
  module Types
    # Represents a 10DLC brand registered for application-to-person messaging. A Brand identifies the business behind
    # one or more messaging campaigns.
    class TenDlcBrand < Internal::Types::Model
      ...
      field :entity_type, -> { Wavix::Types::TenDlcBrandEntityType }, optional: false, nullable: false
